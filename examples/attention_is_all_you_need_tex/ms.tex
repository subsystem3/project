...
\author{
  ...
  Ashish Vaswani\thanks{Equal contribution. Listing order is random. Jakob
    ...
    has been crucially involved in every aspect of this work. Noam proposed scaled
    ...
    Niki designed, implemented, tuned and evaluated countless model variants in our
